...
public class Task1_4 {
    ...
    private static final String realname = "alice"; 
    private static final String realpass = "pass";
    ...
    public static void main(String[] args) {
        ...
        if (realname.equals(name) && realpass.equals(pass)) {
        ...
        if (realpass.equals(pass) && !(realname.equals(name))) {
